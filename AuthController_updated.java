    ...
    public ResponseEntity<UserDTO> getCurrentUser(Authentication authentication) {
        try {
            ...
            if (authentication != null && authentication.getPrincipal() instanceof User) {
                ...
                // Corregir los nombres de los métodos getter
                userDTO.setIsPremium(user.isPremium() != null ? user.isPremium() : false);
                userDTO.setPublicProfile(user.isPublicProfile() != null ? user.isPublicProfile() : true);
